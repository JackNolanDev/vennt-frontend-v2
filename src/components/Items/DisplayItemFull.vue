<template>
  ...
  <DisplayItemEquipToggle :item="item"></DisplayItemEquipToggle>
...
import DisplayItemEquipToggle from "./DisplayItemEquipToggle.vue";
import DisplayWeaponFields from "./DisplayWeaponFields.vue";
